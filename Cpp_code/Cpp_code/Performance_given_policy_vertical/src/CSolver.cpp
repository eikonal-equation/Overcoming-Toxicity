...
void PDE_Solver::Main_PE_Solver() {
	...
	if (fPolicy_name == "constitutive") {
		filename1 = "output/Perf_const_valuefn_rho" + str2 + "_lamb" + str1 + ".dat";
		filename2 = "output/Perf_const_policy_rho" + str2 + "_lamb" + str1 + ".dat";
	}
	else if (fPolicy_name == "myopic") {
		filename1 = "output/Perf_myo_valuefn_rho" + str2 + "_lamb" + str1 + ".dat";
		filename2 = "output/Perf_myo_policy_rho" + str2 + "_lamb" + str1 + ".dat";
	}
