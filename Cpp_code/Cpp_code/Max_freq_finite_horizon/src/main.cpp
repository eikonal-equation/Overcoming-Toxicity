...
int main()
{
	...
	cout << "Running Max Frequency finite horizon Solver: " << endl;

	//array<double,5> lamb_list{0.8,0.85,0.9,0.95,1.0};
	//array<double,5> lamb_list{0.75,0.825,0.875,0.925,0.975};
	...
	//array<double,8> rho_list{0.52,0.53,0.54,0.56,0.57,0.58,0.59};
	...
	// //array<double,3> rho_list{0.60, 0.65, 0.70};
	...
	// 		myExample.writeDomainToFile("output/Max_freq_finite_horizon");
	// 	}
	// }
	...
	// Writing Grid Parameters to file
	std::string file_label = std::to_string(gRefinement_factor);
	myExample.writeDomainToFile("Max_freq_finite_horizon");
