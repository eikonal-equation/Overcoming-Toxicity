 ...
 *============================================================================*/
  ...
  * Here, we specifically handles the case of a hyperbolic boundary condition.
  *
...
public:
		...
		double aEpsilon, double aRks, double aGamma, double aLamb, double aRho)
	{
		...
		fDefeat_thres = aDefeat_thres;  // Threshold for defeat
		fVictory_thres = aVictory_thres; // Threshold for victory
