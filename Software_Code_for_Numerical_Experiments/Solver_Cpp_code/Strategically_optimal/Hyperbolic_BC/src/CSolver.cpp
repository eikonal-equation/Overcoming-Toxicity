...
/*==============================================================================
  ...
  * Here, we specifically handle the case of a hyperbolic boundary condition.
  *
  *============================================================================*/
...
void PDE_Solver::Main_VPI_Solver() {
	...
	CPolicyEvaluation myPEclass(fNx, fNy, fx0, fy0, fDx, fDy, fDefeat_thres, fVictory_thres, fProb_not_arrival, fProb_arrival);
	...
	string filename1 = "Sto_strategic_hyper_valuefn_rho" + aStr2 + "_lamb" + aStr + ".dat";
	string filename2 = "Sto_strategic_hyper_policy_rho" + aStr2 + "_lamb" + aStr + ".dat";
