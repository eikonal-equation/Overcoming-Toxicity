...
int main()
{
	...
	cout << "Running the strategically-optimal killer solver (vertical BC; random dilutions): " << endl;
	...
	myExample.writeDomainToFile("Sto_strategic_opt_vertical_lamb_" + to_string(gLamb) + "_rho_" + to_string(gRho));
