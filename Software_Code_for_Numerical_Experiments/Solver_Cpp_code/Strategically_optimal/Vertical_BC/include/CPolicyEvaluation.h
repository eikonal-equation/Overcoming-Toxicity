...
public:
	...
	CPolicyEvaluation(double aXDim, double aYDim, double aX0, double aY0, double aDx, double aDy,
		 double aDefeat_thres, double aVictory_thres, int aDefeat_indx, int aVictory_indx, double aProb_not_arrival, double aProb_arrival)
	{
		...
		fDefeat_indx = aDefeat_indx; // index of the defeat threshold in the discretized grid
		fVic_indx = aVictory_indx; // index of the victory threshold in the discretized grid
...
private:
	...
	int fDefeat_indx; // index of the defeat threshold in the discretized grid
	int fVic_indx; // index of the victory threshold in the discretized grid
