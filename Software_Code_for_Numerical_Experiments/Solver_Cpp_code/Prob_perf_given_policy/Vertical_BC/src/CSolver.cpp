 ...
 *============================================================================*/
  ...
  * Author: MingYi Wang
  * 
  * Description: This file contains the actual implementation of the class "CPDE_Solver"
...
void PDE_Solver::Main_PE_Solver() {
	...
	if (fPolicy_name == "constitutive") {
		filename1 = "Perf_vertical_const_valuefn_rho" + str2 + "_lamb" + str1 + ".dat";
		filename2 = "Perf_vertical_const_policy_rho" + str2 + "_lamb" + str1 + ".dat";
	}
	else if (fPolicy_name == "tactical") {
		filename1 = "Perf_vertical_tactic_valuefn_rho" + str2 + "_lamb" + str1 + ".dat";
		filename2 = "Perf_vertical_tactic_policy_rho" + str2 + "_lamb" + str1 + ".dat";
	}
