function Visualization_FigS12()
% Visualization_FigS12.m
% This function generates the Fig. S12 in the paper, which visualizes
...
xc_list = linspace(0.1,0.9,9); % Initial fraction of the killer (f_0)
...
load("killer_win_FigS12.mat","nk_win","ns_win","f_win");
load("killer_lose_FigS12.mat","nk_lose","ns_lose","f_lose");
